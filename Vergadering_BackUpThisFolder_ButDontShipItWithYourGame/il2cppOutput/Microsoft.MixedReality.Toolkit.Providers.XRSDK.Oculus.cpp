...
// System.Nullable`1<System.Boolean> Microsoft.MixedReality.Toolkit.XRSDK.LoaderHelpers::IsLoaderActive<Unity.XR.Oculus.OculusLoader>()
...
FINALLY_00c3:
		...
		{// begin try (depth: 1)
			...
			{
				int32_t L_6 = V_4;
				if ((!(((uint32_t)((int32_t)il2cpp_codegen_subtract((int32_t)L_6, ((int32_t)30)))) > ((uint32_t)1))))
				{
					goto IL_0042_1;
				}
			}
...
IL_002e_1:
			{
				...
				InputFeatureUsage_1_tE336B2F0B9AC721519BFA17A08D6353FD5221637 L_7 = ((OculusUsages_t26394A1703082235CAC869B16DF3A491A7965196_StaticFields*)il2cpp_codegen_static_fields_for(OculusUsages_t26394A1703082235CAC869B16DF3A491A7965196_il2cpp_TypeInfo_var))->___indexTouch_1;
				V_2 = L_7;
...
IL_0038_1:
			{
				// buttonUsage = OculusUsages.indexTouch;
				il2cpp_codegen_runtime_class_init_inline(OculusUsages_t26394A1703082235CAC869B16DF3A491A7965196_il2cpp_TypeInfo_var);
				InputFeatureUsage_1_tE336B2F0B9AC721519BFA17A08D6353FD5221637 L_8 = ((OculusUsages_t26394A1703082235CAC869B16DF3A491A7965196_StaticFields*)il2cpp_codegen_static_fields_for(OculusUsages_t26394A1703082235CAC869B16DF3A491A7965196_il2cpp_TypeInfo_var))->___indexTouch_1;
				V_2 = L_8;
				// usingOculusButtonData = true;
				V_3 = (bool)1;
				// break;
...
IL_0042_1:
			{
				...
				il2cpp_codegen_runtime_class_init_inline(OculusUsages_t26394A1703082235CAC869B16DF3A491A7965196_il2cpp_TypeInfo_var);
				InputFeatureUsage_1_tE336B2F0B9AC721519BFA17A08D6353FD5221637 L_9 = ((OculusUsages_t26394A1703082235CAC869B16DF3A491A7965196_StaticFields*)il2cpp_codegen_static_fields_for(OculusUsages_t26394A1703082235CAC869B16DF3A491A7965196_il2cpp_TypeInfo_var))->___thumbrest_0;
				V_2 = L_9;
				// usingOculusButtonData = true;
				V_3 = (bool)1;
			}
...
IL_004a_1:
			...
			}
			{
				...
				GenericXRSDKController_UpdateButtonData_mAF5A0412DE08EAC269E797FDE5F08A9177635673(__this, L_11, L_12, NULL);
				goto IL_00d1;
			}
...
IL_0057_1:
			{
				...
				InputFeatureUsage_1_tE336B2F0B9AC721519BFA17A08D6353FD5221637 L_13 = V_2;
				bool L_14;
				L_14 = InputDevice_TryGetFeatureValue_m24EC3B6C41AE4098269427232AD5F52E786BF884((&___1_inputDevice), L_13, (&V_5), NULL);
				if (!L_14)
				{
					goto IL_006b_1;
				}
			}
			{
				...
				bool L_16 = V_5;
				NullCheck(L_15);
				MixedRealityInteractionMapping_set_BoolData_m216D4A26D41B17B7CB6D4C28A30A38D8D6349ADA(L_15, L_16, NULL);
			}
...
IL_006b_1:
			...
			}
			{
				...
				NullCheck(L_19);
				bool L_20;
				L_20 = MixedRealityInteractionMapping_get_BoolData_m69F4D6E88FF5DF204C3C38426A2BCD74AB7060CB_inline(L_19, NULL);
				if (!L_20)
				{
					goto IL_009f_1;
				}
...
IL_00aa_1:
			{
				...
				L_32 = MixedRealityInteractionMapping_get_MixedRealityInputAction_mE813B3EBBA0A10F64E34EA6E5001D140D81141E9_inline(L_31, NULL);
				NullCheck(G_B19_0);
